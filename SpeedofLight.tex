...
\section{Methods and Procedures}
	...
	The deflections $s'_{cw}$ and $s'_{ccw}$, and the angular frequencies $f_{cw}$ and $f_{ccw}$ at each deflection measurement are directly measured to calculate an experimental value of $c$. 
